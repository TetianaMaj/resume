...
var header = {
  ...
  salary: '600$ в місяць',
  address: 'Zhitomir, Pokrovska str, 125',
}
var footer = {
  social: {
    email: {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        ...
        {
          name: 'Житомирська філія КІБІТ',
          isEnd: false,
        },
        {
          name: 'Житомирський економіко-гуманітарний інститут ВМУРОЛ',
          isEnd: false,
        },
      ],
      certificates: [
          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'Ghgfg jhcxg bcfdgfgv',
                },
                {
                  name: 'Lkjhgg hggfc hjgfv',
                },
              ],
              stackAmount: {
                point: 5,
